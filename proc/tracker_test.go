	...
	tests := []struct {
	...
	}{
		{
			piinfost(p, n, Counts{1, 2, 3, 4, 5, 6, 0, 0}, Memory{7, 8, 0, 0, 0},
				Filedesc{1, 0, 10}, 9, States{Sleeping: 1}),
			Update{n, Delta{}, Memory{7, 8, 0, 0, 0}, Filedesc{1, 0, 10}, tm,
				9, States{Sleeping: 1}, msi{}, nil},
		},
		{
			piinfost(p, n, Counts{2, 3, 4, 5, 6, 7, 0, 0}, Memory{1, 2, 0, 0, 0},
				Filedesc{2, 0, 20}, 1, States{Running: 1}),
			Update{n, Delta{1, 1, 1, 1, 1, 1, 0, 0}, Memory{1, 2, 0, 0, 0},
				Filedesc{2, 0, 20}, tm, 1, States{Running: 1}, msi{}, nil},
		},
	}
...
func TestTrackerThreads(t *testing.T) {
	...
	tests := []struct {
		...
		{
			piinfo(p, n, Counts{}, Memory{}, Filedesc{1, 0, 1}, 1),
			Update{n, Delta{}, Memory{}, Filedesc{1, 0, 1}, tm, 1, States{}, msi{}, nil},
		}, {
			...
			Update{n, Delta{}, Memory{}, Filedesc{1, 0, 1}, tm, 2, States{}, msi{},
				[]ThreadUpdate{
					{"t1", Delta{}},
					{"t2", Delta{}},
				},
			...
			Update{n, Delta{}, Memory{}, Filedesc{1, 0, 1}, tm, 3, States{}, msi{},
				[]ThreadUpdate{
